        ...
        <div className="w-full max-w-[1100px]">
          <div className="flex justify-between">
            <div className="flex items-center gap-2">
              <img className="h-8 w-8" src="/mainlogo.svg" alt="" />
              <span className="text-2xl">ChatterHub</span>
            </div>
            <a
              href="https://github.com/alvin-dennis/Chat-App"
              target="_blank"
          ...
          <div className="flex flex-col-reverse gap-10 md:mt-5 md:flex-row md:gap-5 lg:mt-10">
            <div className="flex-1">
              <img className="h-auto w-full" src="/front.gif" alt="" />
            </div>
            ...
            <div className="mt-12 flex flex-1 flex-col items-center gap-4 md:items-start lg:mt-24">
              ...
              Connect, Communicate, Conquer: Your Chat, Your Way
              </p>
